...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    description: `Developed and maintained web applications using Php, Laravel, and Mysql. Designed and implemented RESTful APIs for data communication. Collaborated with cross-functional teams to deliver high-quality software products on schedule.`,
...
export const PROJECTS = [
  {
    ...
    image: project1,
    description:
      "A fully functional Online Code Editor IDE that supports Java ,JavaScript ,Python ,C++.",
  ...
  },
  {
    ...
    image: project4,
    description:
      "A platform for exam and publishing blog posts, with features like rich text editing, commenting, and user profiles.",
    technologies: ["HTML", "CSS","JavaScript", " Php", "mySQL"], 
  },
];

export const CONTACT = {
  address: "Barabanki,Uttar Pradesh , 225305",
  phoneNo: "+916386277605",
  email: "priyanshuv624@gmail.com",
};
